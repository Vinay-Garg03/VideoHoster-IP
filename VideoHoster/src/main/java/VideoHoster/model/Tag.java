...
public class Tag {
    ...
    // Write the annotation for many to many between videos and tags where they are mapped by tags field in the videos table
    //The 'tags' table is mapped to 'videos' table with Many:Many mapping
    //One video can have multiple categories/tags and there can be multiple videos under one category/tag
    //FetchType is LAZY
