...
public class User {
    ...
    //The 'users' table is referenced by the 'videos' table
    //The table (primary key) is referenced by the 'user' field in the 'videos' table
    //cascade = CascadeType.REMOVE specifies that if a record in 'users' table is deleted, then all the records in 'videos' table associated to that particular record in 'users' table will be deleted first and then the record in the 'users' table will be deleted
    //FetchType is LAZY
